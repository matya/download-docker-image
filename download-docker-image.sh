...
usage() {
    ...
    echo "      -a|--auth-file <file>       Credentials for non-public registry images. Defaults to ~/.docker/config.json"
    echo "      -A|--auth-env <varname>     Environment variable name holding the base64 encoded user:pass."
    echo "      -c|--credentials <creds>    The base64 encoded user:pass. NOT RECOMMENDED! MAY LEAK!"
